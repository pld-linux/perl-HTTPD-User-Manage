...
Summary(pt):	Módulo de Perl HTPD::User::Manage
Summary(pt_BR):	Módulo Perl HTPD::User::Manage
Summary(ru):	íÏÄÕÌØ ÄÌÑ Perl HTPD::User::Manage
Summary(sv):	HTPD::User::Manage Perlmodul
Summary(uk):	íÏÄÕÌØ ÄÌÑ Perl HTPD::User::Manage
Summary(zh_CN):	HTPD::User::Manage Perl Ä£¿é
...
%description -l pt
Módulo de Perl HTPD::User::Manage

%description -l pt_BR
Módulo Perl HTPD::User::Manage

%description -l ru
íÏÄÕÌØ ÄÌÑ Perl HTPD::User::Manage
